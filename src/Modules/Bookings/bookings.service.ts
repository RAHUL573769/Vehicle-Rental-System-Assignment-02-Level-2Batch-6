...
const adminAndUserViewingService = async (role: string, id: number) => {
...
const updateBookingRoleBasedService = async (bookingId: any, status: string, role: string) => {
...
export const BookingServices = { updateBookingRoleBasedService, createBookingsIntoDb, adminAndUserViewingService }