...
router.get("/", vehicles_controllers_1.VehicleController.getVehicles);
router.post("/", (0, auth_1.auth)(auth_types_1.UserRoles.admin), vehicles_controllers_1.VehicleController.createVehicles);
router.get("/:id", vehicles_controllers_1.VehicleController.getSingleVehicles);
